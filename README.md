...
<h2>Description</h2>
This project includes the deployment and network configuration of Azure Cloud resources to create vulnerable machines and use Microsoft Sentinel to monitor and log incidents. Included is configuration of Azure AD (Entra ID), watchlists, analytic rules, and user and entity behavior analytics (UEBA).
<br />
